	...
	public class UsrRealtyFreedomUIEventsSchema : Terrasoft.Core.SourceCodeSchema
	{
		...
		protected virtual SchemaLocalizableString CreateValueIsTooBigLocalizableString() {
			SchemaLocalizableString localizableString = new SchemaLocalizableString() {
				UId = new Guid("848f580c-ef7e-36e3-c27f-040dc217a312"),
				Name = "ValueIsTooBig",
				CreatedInPackageId = new Guid("ecb97a1b-24c8-40ec-b644-07e3c8d131b7"),
				CreatedInSchemaUId = new Guid("c9ba3998-4f6f-41a8-8253-c26e0de611fe"),
				ModifiedInSchemaUId = new Guid("c9ba3998-4f6f-41a8-8253-c26e0de611fe")
			};
